...
if __name__ == '__main__':
    ...
    parser.add_option("--fqdn", dest="fqdn", help="Set an explicit FQDN, overriding detected FQDN from socket.getfqdn(), currently detected as %s" % socket.getfqdn(), metavar="FQDN", default=socket.getfqdn())
